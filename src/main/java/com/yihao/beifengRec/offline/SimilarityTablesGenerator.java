...
*/
    ...
    UserItemSimilarityTableRedisWriter userItemSimilarityTableRedisWriter = new UserItemSimilarityTableRedisWriter(dataModel);
    userItemSimilarityTableRedisWriter.storeToRedis(); // 只是存储用户:商品集合
    ...
    userItemSimilarityTableRedisWriter.waitUtilDone(); // 主线程等待 协同过滤模型计算完毕
  }
